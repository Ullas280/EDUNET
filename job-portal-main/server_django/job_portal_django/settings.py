...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'job_portal_django.cookie_auth.CookieJWTAuthentication',
    ),
}
...
CORS_ALLOW_HEADERS = list(os.environ.get('CORS_ALLOW_HEADERS', 'content-type,authorization').split(','))
# Ensure common Vite dev ports are allowed when developing locally
